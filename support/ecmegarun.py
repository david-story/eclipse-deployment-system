...
Description: This is a file that runs the EC2 servers after they have been created and have had all software
copied to them. 
""""
...
# From the .csv gets the instance ids and creates instance objects to 
# manipulate using boto3
...
def get_instances(instance_file_path):
    ...
    csvfile.close()
    fixed_file = []
	# parses some error that I was lazy not to fiz here :(
